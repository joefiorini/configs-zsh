...
export PATH="./.bundle/bin:/usr/local/share/npm/bin:$HOME/.sm/bin:$HOME/Projects/oss-vendor/depot-tools:/Users/joe/.cabal/bin:./node_modules/.bin:/usr/local/bin:$PATH:$HOME/bin"
export PAGER="less"
...
export GOPATH="$HOME/Projects/triforce.io"
